...
class PromptTemplate(rx.Model, table=True):
    prompt_repr: str = Field(..., description="The prompt representation, e.g. SQL, TEXT, etc.")
    ...
    prompt_template_name: str = Field(..., description="The name of the prompt template.")
    prompt_lines: str = Field(..., description="The prompt template lines.")
    prompt_template_type: Optional[str] = Field(default="custom", description="The type of prompt template.")
