...
class TestModelProvider:
    ...
    def test_gemini_import_error(self):
        ...
        with patch("ryoma_ai.llm.provider.ChatGoogleGenerativeAI", side_effect=ImportError("No module named 'langchain_google_genai'")):
    ...
    def test_openai_import_error(self):
        ...
        with patch("ryoma_ai.llm.provider.ChatOpenAI", side_effect=ImportError("No module named 'langchain_openai'")):
    ...
    def test_anthropic_import_error(self):
        ...
        with patch("ryoma_ai.llm.provider.ChatAnthropic", side_effect=ImportError("No module named 'langchain_anthropic'")):
    ...
    def test_model_initialization_error(self):
        ...
        with patch("ryoma_ai.llm.provider.ChatOpenAI", side_effect=Exception("API key not found")):
