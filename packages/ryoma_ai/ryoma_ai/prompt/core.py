...
class PromptRegistry:
    ...
    def register_selector(self, strategy: SelectorStrategy, selector: ExampleSelector) -> None:
        """Register an example selector for a specific strategy."""
        self._selectors[strategy] = selector
    
    def register_formatter(self, format_type: ExampleFormat, formatter: ExampleFormatter) -> None:
