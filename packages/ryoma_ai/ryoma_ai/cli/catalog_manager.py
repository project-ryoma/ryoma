...
class CatalogManager:
    ...
    def index_catalog(self, datasource_id: str, datasource: DataSource, level: str = "table") -> bool:
        """
        ...
        try:
            ...
            self.console.print(f"[green]✅ Catalog indexed with ID: {catalog_id}[/green]")
            return True
