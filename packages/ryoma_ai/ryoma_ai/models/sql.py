...
class SqlQueryResult:
    ...
    def get_error_details(self) -> Dict[str, Any]:
        ...
        if self.error:
            return {
                ...
                "database_type": self.error.database_type.value if self.error.database_type else None,
                ...
                "recovery_strategies_count": len(self.error.recovery_strategies) if self.error.recovery_strategies else 0
            }
        else:
            # Legacy fallback
            return {
    ...
    def get_recovery_strategies(self, auto_only: bool = False) -> List[RecoveryStrategy]:
        ...
        if auto_only:
            return [
                strategy for strategy in self.error.recovery_strategies
                if strategy.auto_applicable and not strategy.requires_user_input
            ]
