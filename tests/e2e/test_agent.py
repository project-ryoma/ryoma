...
USE_OPENAI = (
    ...
    and os.environ.get("USE_OPENAI_FOR_TESTS", "").lower() == "true"
)
USE_GPT4ALL = (
    not USE_OPENAI and os.environ.get("USE_GPT4ALL_FOR_TESTS", "").lower() == "true"
)
...
if USE_GPT4ALL:
    ...
    pytest.skip(
        "No LLM backend configured. Set USE_OPENAI_FOR_TESTS=true or USE_GPT4ALL_FOR_TESTS=true",
