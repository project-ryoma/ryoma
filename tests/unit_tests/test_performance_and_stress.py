...
class TestThroughputAndConcurrency:
    ...
    def test_concurrent_tool_execution_throughput(self):
        ...
        for num_threads in concurrency_levels:
            ...
            print(f"Concurrency {num_threads}: {throughput:.1f} ops/sec, "
        ...
        assert datasource.query_count >= expected_total_queries * 0.9  # Allow some tolerance
    ...
    def test_store_concurrent_access_performance(self):
        ...
        def concurrent_access_worker(worker_id: int, num_accesses: int) -> Dict[str, float]:
            access_times = []
            retrieval_times = []
    ...
    def test_workflow_agent_performance(self):
        ...
        from ryoma_ai.agent.workflow import WorkflowAgent, ToolMode
        ...
        class FastMockModel(BaseChatModel):
            ...
            def _generate(self, messages, stop=None, **kwargs):
                ...
                mock_generation.message = AIMessage(content=f"Response {self.call_count}")
                mock_result = Mock()
...
class TestMemoryUsageAndLeaks:
    ...
    def test_tool_execution_memory_stability(self):
        ...
        print(f"Memory growth after {num_operations} operations: {memory_growth:.1f} MB")
    ...
    def test_concurrent_execution_memory_efficiency(self):
        ...
        print(f"Memory growth with {num_threads} concurrent threads: {memory_growth:.1f} MB")
...
class TestLatencyAndResponseTime:
    ...
    def test_latency_distribution(self):
        ...
        for delay in delay_scenarios:
            ...
            print(f"Delay {delay:.3f}s - Avg: {avg_latency:.4f}s, "
